...
namespace WhiskeyRealism.Tactical
{
    ...
    public sealed class TacticalDeploymentSnapshot
    {
        ...
        public string Phase
        {
            get { return EodCycle > 0 || BattlePassedDays > 0 ? "eod" : "initial"; }
        }

        public static TacticalDeploymentSnapshot Empty(string label, int alliance, int eodCycle, int battlePassedDays)
        {
            return new TacticalDeploymentSnapshot(label, alliance, eodCycle, battlePassedDays, Array.Empty<TacticalDeploymentGroupSnapshot>());
        }
    }
    ...
    public static class TacticalDeploymentTelemetry
    {
            ...
            TacticalDeploymentSnapshot after)
        {
            ...
            return new TacticalDeploymentDelta
            {
                ...
                EodCycle = after.EodCycle,
                BattlePassedDays = after.BattlePassedDays,
        ...
        {
            if (delta == null) delta = new TacticalDeploymentDelta { Surface = "-", Phase = "initial", Alliance = -1 };
        ...
        private static string Bucket(float value)
        {
            ...
            return (Math.Round(value / 25f) * 25f).ToString("0");
        }
