...
- Don't expand workstream scope without an aligned spec. Current active work is strategic-layer theater integrity / anti-zerg smoke follow-up; see `docs/superpowers/plans/2026-05-05-strategic-anti-zerg-theater-integrity.md`. Slice B (tactical brain) has draft specs and plans, but it is paused unless the user explicitly reopens tactical work. Slices C (W&L hierarchy AI) and D (additional historical flavor) remain deferred.
