...
- Don't expand workstream scope without an aligned spec/plan. Current active work is strategic-layer operational probe/contact smoke follow-up; see `docs/superpowers/plans/2026-05-05-strategic-operational-probe-contact.md`. Slice B (tactical brain) has draft specs and plans, but it is paused unless the user explicitly reopens tactical work. Slices C (W&L hierarchy AI) and D (additional historical flavor) remain deferred.
