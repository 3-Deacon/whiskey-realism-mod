...
- **Build/deploy proof:** console harness `766 PASS / 0 FAIL`; `./build.sh` passed with `0 Warning(s)` / `0 Error(s)`; local `dist/WhiskeyRealism.dll` and deployed BepInEx plugin match SHA-256 `d980632ef26a9fbc7870ce5717aa53ef433e417632fa975d23e076b9121dee80` (890880 bytes).
- **Runtime smoke:** pending. Current `LogOutput.log` mtime `2026-05-10 22:02:36 -0500` predates the deployed plugin timestamp `2026-05-10 22:02:38 -0500`, so it cannot prove Active operations-ledger runtime behavior.
