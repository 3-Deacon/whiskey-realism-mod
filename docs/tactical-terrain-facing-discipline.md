...
- **Implementation branch:** `tactical-terrain-facing-discipline`
...
- **Build/deploy proof:** local `dist/WhiskeyRealism.dll` and deployed BepInEx plugin match SHA-256 `0b9a5d2274d5c79ebfa64a9cfa36ffc21a3e3100ffdbfb3ed68a5810819f853c` (834048 bytes).
