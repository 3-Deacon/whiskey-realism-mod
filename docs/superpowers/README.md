...
Slice-level design and execution artifacts. Living-doc state lives in [`docs/handoff.md`](../handoff.md), [`docs/patch-catalog.md`](../patch-catalog.md), [`docs/tactical-orchestrator.md`](../tactical-orchestrator.md), [`docs/findings.md`](../findings.md), [`docs/bug-fixes/`](../bug-fixes/), [`docs/fort-construction-governor.md`](../fort-construction-governor.md), [`docs/operational-tempo-doctrine.md`](../operational-tempo-doctrine.md), [`docs/wl-dispatch-objective-bridge.md`](../wl-dispatch-objective-bridge.md), [`docs/coordinated-operation-packages.md`](../coordinated-operation-packages.md), [`docs/historical-operation-doctrine.md`](../historical-operation-doctrine.md), and [`MEMORY.md`](../../MEMORY.md).
...
- [`plans/`](plans/) — **active** implementation plans. Current tactical-orchestrator execution artifacts are Slice 1 reserve commitment and Slice 3 charge gate; current operational status lives in [`../tactical-orchestrator.md`](../tactical-orchestrator.md). Slice 1 is merged to `main` and build/deploy/hash verified at SHA-256 `82b1d91a31d4e269398d237690f279f80974c86bb69756bf59dd0e0a3254c4d5` (803328 bytes), with focused battle smoke pending. Slice 3 is implemented on `orchestrator-slice-3-charge-gate` and build/deploy/hash verified at SHA-256 `ac77b132594e71e8b74c0aa81222fa45f1936f4852467d1489a4841af8fc1b25` (810496 bytes), with focused gate-OFF/gate-ON smoke pending before merge/release claims. Older Slice B tactical brain plans are archived; use living docs for current behavior.
