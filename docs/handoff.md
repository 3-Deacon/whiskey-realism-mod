...
| **Main branch current** | **Post-v0.2.2 checkpoint.** Built and deployed DLL SHA-256 is `f1f456bd273b72e0640232cbee5b8a6b761c3fb77b14e4dc6b1cd614e2bcff6a`. Adds locked-Hard casualty tolerance, #7 role-aware campaign perk steering, and a hardened #22 W&L command-selection retry on top of the released v0.2.2 smoke-confirmed build. |
