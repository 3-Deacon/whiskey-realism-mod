...
| **Main branch current** | **Post-v0.2.2 checkpoint `2ccc743`.** Built and deployed DLL SHA-256 is `5852e56aaa613aa636767fb96d75546f3ef4ee8ed1b99c016aff2a16483ec29b`. Adds locked-Hard casualty tolerance plus #7 role-aware campaign perk steering on top of the released v0.2.2 smoke-confirmed build. |
