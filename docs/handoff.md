...
| **Main branch current** | **Post-v0.2.2 checkpoint.** Built and deployed DLL SHA-256 is `3b0423317bd62c78062bf62929dee6e6432dbda029e865196b82c9eaa88c630d`. Adds locked-Hard casualty tolerance, #7 role-aware campaign perk steering, and a hardened #22 W&L command-selection retry on top of the released v0.2.2 smoke-confirmed build. |
