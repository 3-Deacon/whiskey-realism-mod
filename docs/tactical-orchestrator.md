...
| #61 operations-ledger posture executor + doctrine consumers | Shipped on `main` | Harness/build/deploy/hash verified at `27a723b14f81ab5f77579a08105ff131642a21ca5bd1416074e86b7c1b5febbb`; Active smoke pending fresh battle log |
...
1. Run Active full-spectrum doctrine battle smoke on deployed DLL `27a723b14f81ab5f77579a08105ff131642a21ca5bd1416074e86b7c1b5febbb` and prove `[TacticalCommanderMode] mode=Active`, `[TacticalOpsLedger]`, `[TacticalCommandAssignment]`, `[TacticalCommandPosture]`, `[TacticalPostureSummary]`, `[TacticalGroupDecision]`, `[TacticalDoctrineCharge]`, `[TacticalOrchestratorChargeGate]`, bounded reserve/fallback rows, no repeated errors, and no player-subordinate retasking.
