...
| #61 operations-ledger posture executor + doctrine consumers | Shipped on `main` | Harness/build/deploy/hash verified at `f2b2e7b8c2c1c78b608870cb6b729d166c5a718410979aebf1ba20db8eb4c4c0`; Active smoke pending fresh battle log |
...
1. Run Active full-spectrum doctrine battle smoke on deployed DLL `f2b2e7b8c2c1c78b608870cb6b729d166c5a718410979aebf1ba20db8eb4c4c0` and prove `[TacticalCommanderMode] mode=Active`, `[TacticalOpsLedger]`, `[TacticalCommandAssignment]`, `[TacticalCommandPosture]`, `[TacticalPostureSummary]`, `[TacticalGroupDecision]`, `[TacticalDoctrineCharge]`, bounded reserve/fallback rows, no repeated errors, and no player-subordinate retasking.
