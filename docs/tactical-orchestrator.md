...
| #61 operations-ledger posture executor + doctrine consumers | Shipped on `main` | Harness/build/deploy/hash verified at `5fdcee189d391502ac85eb107aa894d4d09fe91f5f77fb7fcd3fcbaf775e895b`; Active smoke pending fresh battle log |
...
1. Run Active full-spectrum doctrine battle smoke on deployed DLL `5fdcee189d391502ac85eb107aa894d4d09fe91f5f77fb7fcd3fcbaf775e895b` and prove `[TacticalCommanderMode] mode=Active`, `[TacticalOpsLedger]`, `[TacticalCommandAssignment]`, `[TacticalCommandPosture]`, `[TacticalPostureSummary]`, `[TacticalGroupDecision]`, `[TacticalDoctrineCharge]`, `[TacticalOrchestratorChargeGate]`, bounded reserve/fallback rows, no repeated errors, and no player-subordinate retasking.
