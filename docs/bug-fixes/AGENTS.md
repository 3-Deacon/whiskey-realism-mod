...
- Use this area for confirmed or strongly suspected vanilla bugs, shipped runtime hazards, and evidence-backed Whiskey guards for vanilla failure modes.
...
- `Backlog` — likely bug or vanilla AI flaw, but implementation still needs bounded design.
