...
The available `LogOutput.log` is stale relative to the latest deployed DLL: the log mtime was `2026-05-11 21:52:44 -0500`, while the latest deployed `WhiskeyRealism.dll` was `2026-05-14 10:51:57 -0500` with SHA-256 `f2e7705b96c55ea371ca08a3a56d28ebf324bfc114618c184ccba375d17ee1f1`. Treat this section as evidence for vanilla fault classification, not proof that the latest guard failed.
