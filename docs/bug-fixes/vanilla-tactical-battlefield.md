...
Focused W&L battle smoke ran with `Enable Tactical Observer = true`, `Enable Tactical Bug Telemetry = true`, `Enable Tactical Fallback Retreat Null Guard = true`, `Enable W&L Tactical Charge Guard = true`, verbose observer logging off, and summary throttle 30 seconds. That smoke ran on DLL SHA-256 `2a7bf702f6408e2a131a43fe6aa1a9ee04b56175ee292375c5167344c29c14c1` (519680 bytes). Current deployed DLL SHA-256 is `1f5ae70f1ba4c561e2afd9afe8fd571dc122e06967d8055272f8c2842693e857` (587264 bytes) and adds #46 objective-chain filtering plus config-gated `[TacticalDecisionMatrix]` rows. Live B4/B5 smoke emitted 37,250 matrix rows, 19 macro decisions, and 45 group decisions without exception spam, then fixed the observed no-measured-enemy weak-point inflation and matrix W&L/order-friction label inversion. B4/B5 remain default-off in C# defaults because they write behavior-changing vanilla battle state, but the live config has them enabled for focused smoke.
