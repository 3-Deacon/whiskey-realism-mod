...
The available `LogOutput.log` is stale relative to the latest deployed DLL: the log mtime was `2026-05-11 19:56:59 -0500`, while the latest deployed `WhiskeyRealism.dll` was `2026-05-11 20:01:30 -0500` with SHA-256 `27a723b14f81ab5f77579a08105ff131642a21ca5bd1416074e86b7c1b5febbb`. Treat this section as evidence for vanilla fault classification, not proof that the latest guard failed.
