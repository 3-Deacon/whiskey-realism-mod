...
Focused W&L battle smoke ran with `Enable Tactical Observer = true`, `Enable Tactical Bug Telemetry = true`, `Enable Tactical Fallback Retreat Null Guard = true`, `Enable W&L Tactical Charge Guard = true`, verbose observer logging off, and summary throttle 30 seconds. That smoke ran on DLL SHA-256 `2a7bf702f6408e2a131a43fe6aa1a9ee04b56175ee292375c5167344c29c14c1` (519680 bytes). Current deployed DLL SHA-256 is `c5fff3e2248774e1853570ef6c3c9936cfdffb4a99f0111ac2781b8b1b2d2f97` (588800 bytes) and adds #46 objective-chain filtering plus config-gated `[TacticalDecisionMatrix]` rows. Live B4/B5 smoke emitted 37,250 matrix rows, 19 macro decisions, and 45 group decisions without exception spam, then fixed the observed no-measured-enemy weak-point inflation, matrix W&L/order-friction label inversion, B4 macro force-balance/no-sector inference, and B5 defensive weak-point/probe fallback to hold. Macro scoring now uses actual `AIBattle.unitsused` contact/sector evidence, no-contact tactical odds are zero, and B5 now maps defensive weak points plus explicit Probe sectors to stance 1 screening/probe so vanilla can form probing groups into line. B4/B5 remain default-off in C# defaults because they write behavior-changing vanilla battle state, but the live config has them enabled for focused smoke. Current runtime proof still needs a restart because the tailed log predates the 18:43 local deploy.
