...
The available `LogOutput.log` is stale relative to the latest deployed DLL: the log mtime was `2026-05-11 21:52:44 -0500`, while the latest deployed `WhiskeyRealism.dll` was `2026-05-15 20:20:19 -0500` with SHA-256 `cfdb9018bc0cb7c0fcb7ba1e28acac0b1b119243856ef3a027716f8b9b930e75`. Treat this section as evidence for vanilla fault classification, not proof that the latest guard failed.
