...
The available `LogOutput.log` is stale relative to the latest deployed DLL: the log mtime was `2026-05-11 21:21:44 -0500`, while the latest deployed `WhiskeyRealism.dll` was `2026-05-11 21:36:28 -0500` with SHA-256 `5fdcee189d391502ac85eb107aa894d4d09fe91f5f77fb7fcd3fcbaf775e895b`. Treat this section as evidence for vanilla fault classification, not proof that the latest guard failed.
