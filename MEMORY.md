...
1. **Strategic operational-probe runtime smoke**: restart GTCW with the deployed DLL, tail `LogOutput.log`, and confirm `[OperationalProbe]` decisions are bounded and warning-free while anti-zerg checks still pass. See `docs/superpowers/plans/archive/2026-05-05-strategic-operational-probe-contact.md`.
