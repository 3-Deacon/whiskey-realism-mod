...
**v0.2.2 released. Current development state is tracked in living docs, not this README.** Post-release tactical work now includes tactical orchestrator O0/O1/O2/O3, #58 deployment observer, Slice 0 command-node tree, Slice 1 reserve commitment gate, Slice 3 #41 command-role charge gate, #60 deployment terrain/facing discipline, #61 tactical operations-ledger posture execution, and full-spectrum doctrine consumers for stance/charge/reserve/fallback/artillery. Current `main` is build/deploy/hash verified with console harness **830 PASS / 0 FAIL**, `./build.sh` clean, and deployed DLL SHA-256 `27a723b14f81ab5f77579a08105ff131642a21ca5bd1416074e86b7c1b5febbb` (930816 bytes). Fresh Active command-doctrine smoke is still pending because the current log predates this deploy. See [`docs/handoff.md`](docs/handoff.md), [`docs/tactical-orchestrator.md`](docs/tactical-orchestrator.md), [`docs/tactical-operations-ledger.md`](docs/tactical-operations-ledger.md), and [`docs/tactical-terrain-facing-discipline.md`](docs/tactical-terrain-facing-discipline.md).
