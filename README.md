...
**v0.2.2 released. Post-release main is built and deployed with SHA-256 `217895fb2fc8db9ca5c48896aa95ab9143d8c74194923403206e9c05a0ae8508`. Runtime smoke confirms the W&L command picker works, time advances after command selection, and normal campaign systems fire without #22 errors. Construction steering Slice B is deployed; optional telegraph AI remains default-off and still needs an enabled smoke run. Role-aware perk assignment is present but remains conditional on vanilla perk timing.**
