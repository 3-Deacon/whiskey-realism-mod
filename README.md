...
**v0.2.2 released. Current development state is tracked in living docs, not this README.** Post-release `main` contains the reconciled strategic/bug-fix streams plus tactical orchestrator O0/O1/O2/O3, #58 deployment observer, Slice 0 command-node tree, and Slice 1 reserve commitment gate. The current `main` DLL is build/deploy/hash verified at SHA-256 `82b1d91a31d4e269398d237690f279f80974c86bb69756bf59dd0e0a3254c4d5` (803328 bytes) with console harness **689 PASS / 0 FAIL**. Active branch `orchestrator-slice-3-charge-gate` adds the Slice 3 #41 command-role charge gate and is build/deploy/hash verified at SHA-256 `ac77b132594e71e8b74c0aa81222fa45f1936f4852467d1489a4841af8fc1b25` (810496 bytes); focused gate-OFF/gate-ON in-game smoke is still pending because the current log predates that deploy. See [`docs/tactical-orchestrator.md`](docs/tactical-orchestrator.md) and [`docs/handoff.md`](docs/handoff.md) for current tactical status and smoke gates.
