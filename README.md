...
**v0.2.2 released. Current development state is tracked in living docs, not this README.** Post-release tactical work now includes tactical orchestrator O0/O1/O2/O3, #58 deployment observer, Slice 0 command-node tree, Slice 1 reserve commitment gate, Slice 3 #41 command-role charge gate, #60 deployment terrain/facing discipline, and #61 tactical operations-ledger posture execution. Current `main` is build/deploy/hash verified with console harness **766 PASS / 0 FAIL**, `./build.sh` clean, and deployed DLL SHA-256 `d980632ef26a9fbc7870ce5717aa53ef433e417632fa975d23e076b9121dee80` (890880 bytes). Fresh Active operations-ledger smoke is still pending because the current log predates this deploy. See [`docs/handoff.md`](docs/handoff.md), [`docs/tactical-orchestrator.md`](docs/tactical-orchestrator.md), [`docs/tactical-operations-ledger.md`](docs/tactical-operations-ledger.md), and [`docs/tactical-terrain-facing-discipline.md`](docs/tactical-terrain-facing-discipline.md).
